      ...
      <div className="glass-card-premium p-10 rounded-2xl">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-6">
          <div className="text-center">
            ...
            <div className="text-xs text-muted-foreground font-semibold">Surahs</div>
          </div>
          <div className="text-center">
            <div className="text-4xl font-bold gradient-text mb-3">6,236</div>
            <div className="text-xs text-muted-foreground font-semibold">Ayahs</div>
          </div>
          <div className="text-center">
          ...
          <div className="text-center">
            <div className="text-4xl font-bold gradient-text mb-3">50</div>
          ...
          <div className="text-center">
            ...
            <div className="text-xs text-muted-foreground font-semibold">Divine Names</div>
          </div>
          <div className="text-center">
            <div className="text-4xl font-bold gradient-text mb-3">15</div>
            <div className="text-xs text-muted-foreground font-semibold">Stories</div>
          </div>
          <div className="text-center">
            <div className="text-4xl font-bold gradient-text mb-3">PDF</div>
            <div className="text-xs text-muted-foreground font-semibold">Books Library</div>
          </div>
          <div className="text-center">
            <div className="text-4xl font-bold gradient-text mb-3">4</div>
            <div className="text-xs text-muted-foreground font-semibold">Translations</div>
          </div>
        </div>
      </div>
    </div>
