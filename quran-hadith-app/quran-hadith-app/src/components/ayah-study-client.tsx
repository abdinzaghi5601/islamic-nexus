              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full mt-1 px-3 py-2 border rounded-md bg-white text-black border-gray-300"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full mt-1 px-3 py-2 border rounded-md h-24 bg-white text-black border-gray-300"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full mt-1 px-3 py-2 border rounded-md h-32 bg-white text-black border-gray-300"
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
          ...
          <div className="flex gap-2 flex-wrap">
            ...
            <select
              ...
              className="px-3 py-2 border rounded-lg bg-white text-sm min-w-[200px] text-black border-gray-300"
            >
